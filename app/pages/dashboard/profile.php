                ...
                <div class="col-md-8 p-5 mx-auto" style="border-style: solid;">
                    ...
                    <div class="avatar" style="margin-top: 18px;">
                        ...
                        <div class="center my-5">
                            <label class="img-label">
                                <div class="image-container">
                                    <img src="<?= get_image($row['profile_img'], 'avatar.png') ?>" alt="Image profile"
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group"><label style="margin-right: 20px;">Full name</label>
                                    <input class="form-control" value="<?= old_value('full_name', $row['full_name']) ?>"
                        ...
                        <div class="form-group"><label>About</label><textarea class="form-control"
                                name="about"><?= old_value('about', $row['about']) ?></textarea></div>

                        <div class="form-group"><label>Email </label>
                            <input class="form-control" type="email" value="<?= old_value('email', $row['email']) ?>"
