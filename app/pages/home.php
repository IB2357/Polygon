...
<body>
    ...
    <h2
        ...
        <strong><span style="color: rgb(33, 37, 41);">most viewed</span></strong></h2>
    <div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 cust_blogteaser" style="padding-bottom: 20px;margin-bottom: 32px;"><a href="#"><img
                            class="img-fluid" style="height: auto;" src="<?= ROOT ?>/assets/img/image_03.png"></a>
                    <h3
                        ...
                        INS: Claims Executive Forum 2018<br></h3>
                    <p class="text-secondary"
                        ...
                        gravida. Aliquam varius finibus est, interdum justo suscipit id. </p>
    ...
    <div id="pagination" class="d-flex justify-content-center" style="padding-bottom: 0px;margin-top: 43px;"><a
            class="pagination-item disabled" href="#"><img
                src="<?= ROOT ?>/assets/img/icon_arrow-left.svg"><span>Previos</span></a><a class="pagination-item active"
            href="#">&nbsp;Home&nbsp;</a><a class="pagination-item" href="#"><span>Next</span><img
                src="<?= ROOT ?>/assets/img/icon_arrow-right.svg"></a></div>
    <hr
